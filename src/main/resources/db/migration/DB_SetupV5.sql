...
CREATE TABLE `CAMPAIGNS` (
  `idCAMPAIGNS` int NOT NULL AUTO_INCREMENT,
  `campaignName` varchar(45) NOT NULL,
  `roomNumber` int NOT NULL,
  `playerHeroID` int NOT NULL,
  `userID` int NOT NULL,
  PRIMARY KEY (`idCAMPAIGNS`),
  UNIQUE KEY `idCAMPAIGNS_UNIQUE` (`idCAMPAIGNS`),
...
INSERT INTO `HEROES` VALUES (1,'ORDER',1,100,50,5,5,4);
...
INSERT INTO `USERS` VALUES (1,'testuser','$2a$10$GIaHENxLpohMXBbGvtPyC.5BGs8tDugJI9UAiYL1aSusF.kvwrdCi',1),(2,'tester','$2a$10$vddjL3hV656X46KKowgt3O.Jt/YZ/OGKo/u7V/4AqPQsDN6Bhe36e',18),(3,'anafil','$2a$10$uDLfDU66hwQ56IICFpcq0eLeMUcSlPRU8CilL4eMoS4IwQfLwoSDe',0),(4,'lol','$2a$10$4rIG0PIq/cAe6yegrddPduX1GIly0Dfoz3H0Izx2BTx5eC9i6vJ..',0),(5,'adam','$2a$10$7tUPLmw//bystOoyCvliKuobbFntvzstJDYkoRYNcv53GLcpf.FtO',0),(6,'adam1','$2a$10$riPmLIwTNh2psVMZu7i6LuFRBxDPdLKdyACuuyB/n0baApSKeNZdG',0);
...
-- Dump completed on 2026-03-28  1:07:19
